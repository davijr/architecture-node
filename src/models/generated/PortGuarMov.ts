...
export interface PortGuarMovAttributes {
...
export type PortGuarMovPk = "referenceDate" | "movementDescription" | "tradeDate" | "sourceSystem" | "productCode" | "contractReference";
export type PortGuarMovId = PortGuarMov[PortGuarMovPk];
export type PortGuarMovOptionalAttributes = "firstContractReference" | "participationFlag" | "startDate" | "maturityDate" | "notional" | "notionalOutstanding" | "notionalUpdateFixedRate" | "notionalUpdateIndexPercent" | "notionalUpdateTenorFrequencyUnit" | "notionalUpdateFrequencyUnit" | "notionalUpdateNextDate" | "notionalUpdateLastDate" | "effectiveYield" | "originalCost" | "fairValue" | "fairValueAccumChanges" | "outstanding" | "amortizedCost" | "acquisitionDate" | "unrealizedGainLoss" | "forbearanceDate" | "performingStatus" | "performingStatusChangeDate" | "pastDueDays" | "pastDueInstallments" | "pastDuePrincipal" | "pastDueInterest" | "pastDueFee" | "defaultDate" | "recoveriesSinceDefault";
export type PortGuarMovCreationAttributes = Optional<PortGuarMovAttributes, PortGuarMovOptionalAttributes>;

export class PortGuarMov extends Model<PortGuarMovAttributes, PortGuarMovCreationAttributes> implements PortGuarMovAttributes {
  referenceDate!: string;
  movementDescription!: string;
  tradeDate!: string;
  sourceSystem!: string;
  ...
  // PortGuarMov belongsTo CompanyCostCentre via companyCode
  ...
  // PortGuarMov belongsTo CompanyCostCentre via costCentre
  ...
  // PortGuarMov belongsTo DomsAccrualBasis via notionalUpdateAccrualBasis
  ...
  // PortGuarMov belongsTo DomsCalcFrequency via notionalUpdateFrequency
  ...
  // PortGuarMov belongsTo DomsCalcFrequency via notionalUpdateTenorFrequency
  ...
  // PortGuarMov belongsTo DomsFairValueOption via fairValueOption
  ...
  // PortGuarMov belongsTo DomsForbearanceMeasures via forbearanceMeasures
  ...
  // PortGuarMov belongsTo DomsParticipationFlag via participationFlag
  ...
  // PortGuarMov belongsTo DomsPerformingStatus via performingStatus
  ...
  // PortGuarMov belongsTo DomsRateType via notionalUpdateRateType
  ...
  // PortGuarMov belongsTo DomsSubType via subType
  ...
  // PortGuarMov belongsTo Product via productCode
  ...
  // PortGuarMov belongsTo SysCountry via originationCountry
  ...
  // PortGuarMov belongsTo SysCurrency via currencyCode
  ...
  // PortGuarMov belongsTo SysExternalSystem via sourceSystem
  ...
  // PortGuarMov belongsTo SysUnderlying via notionalUpdateIndex
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortGuarMov {
    return PortGuarMov.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_guar_mov',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_GUAR_MOV",
        unique: true,
        fields: [
          { name: "reference_date" },
      ...
      {
        name: "port_guar_mov_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
