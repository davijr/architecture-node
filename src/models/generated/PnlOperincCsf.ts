...
export type PnlOperincCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PnlOperincCsfId = PnlOperincCsf[PnlOperincCsfPk];
export type PnlOperincCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PnlOperincCsfCreationAttributes = Optional<PnlOperincCsfAttributes, PnlOperincCsfOptionalAttributes>;

export class PnlOperincCsf extends Model<PnlOperincCsfAttributes, PnlOperincCsfCreationAttributes> implements PnlOperincCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PnlOperincCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PnlOperincCsf belongsTo DomsCapType via capType
  ...
  // PnlOperincCsf belongsTo DomsCapType via floorType
  ...
  // PnlOperincCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PnlOperincCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PnlOperincCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PnlOperincCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PnlOperincCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PnlOperincCsf belongsTo DomsIncomeType via incomeType
  ...
  // PnlOperincCsf belongsTo DomsPayReceive via legType
  ...
  // PnlOperincCsf belongsTo DomsRateType via rateType
  ...
  // PnlOperincCsf belongsTo PnlOperincCsfLink via companyCode
  companyCodePnlOperincCsfLink!: PnlOperincCsfLink;
  getCompanyCodePnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setCompanyCodePnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createCompanyCodePnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo PnlOperincCsfLink via contractReference
  contractReferencePnlOperincCsfLink!: PnlOperincCsfLink;
  getContractReferencePnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setContractReferencePnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createContractReferencePnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo PnlOperincCsfLink via productCode
  productCodePnlOperincCsfLink!: PnlOperincCsfLink;
  getProductCodePnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setProductCodePnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createProductCodePnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo PnlOperincCsfLink via referenceDate
  referenceDatePnlOperincCsfLink!: PnlOperincCsfLink;
  getReferenceDatePnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setReferenceDatePnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createReferenceDatePnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo PnlOperincCsfLink via sourceSystem
  sourceSystemPnlOperincCsfLink!: PnlOperincCsfLink;
  getSourceSystemPnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setSourceSystemPnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createSourceSystemPnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo PnlOperincCsfLink via sourceTable
  sourceTablePnlOperincCsfLink!: PnlOperincCsfLink;
  getSourceTablePnlOperincCsfLink!: Sequelize.BelongsToGetAssociationMixin<PnlOperincCsfLink>;
  setSourceTablePnlOperincCsfLink!: Sequelize.BelongsToSetAssociationMixin<PnlOperincCsfLink, PnlOperincCsfLinkId>;
  createSourceTablePnlOperincCsfLink!: Sequelize.BelongsToCreateAssociationMixin<PnlOperincCsfLink>;
  // PnlOperincCsf belongsTo SysCurrency via currencyCode
  ...
  // PnlOperincCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PnlOperincCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PnlOperincCsf {
    return PnlOperincCsf.init({
    referenceDate: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      primaryKey: true,
      references: {
        model: 'pnl_operinc_csf_link',
        key: 'source_table'
      },
    ...
    sequelize,
    tableName: 'pnl_operinc_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PNL_OPERINC_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
