...
export interface PortFoexMovAttributes {
...
export type PortFoexMovPk = "referenceDate" | "movDescription" | "tradeDate" | "sourceSystem" | "productCode" | "contractReference";
export type PortFoexMovId = PortFoexMov[PortFoexMovPk];
export type PortFoexMovOptionalAttributes = "structureReference" | "glClass" | "bankingTrading" | "fwdStartCorrectionFixDate" | "fwdStartCorrectionFxRate" | "fwdStartCorrectionUnderlyingPerc" | "floatIndexPercentageRecLeg" | "floatIndexPercentagePayLeg" | "yieldRecLeg" | "yieldPayLeg" | "accrualBasisRecLeg" | "accrualBasisPayLeg" | "multiplierTypeRecLeg" | "multiplierTypePayLeg" | "multiplierValueRecLeg" | "multiplierValuePayLeg" | "fixingStartDateRecLeg" | "fixingStartDatePayLeg" | "fixingNextDateRecLeg" | "fixingNextDatePayLeg" | "fixingSettlementDateRecLeg" | "fixingSettlementDatePayLeg" | "recDate" | "payDate" | "modDurationRecLeg" | "modDurationPayLeg" | "performingStatus" | "pastDueDays" | "pastDueInstalments" | "tradeTime";
export type PortFoexMovCreationAttributes = Optional<PortFoexMovAttributes, PortFoexMovOptionalAttributes>;

export class PortFoexMov extends Model<PortFoexMovAttributes, PortFoexMovCreationAttributes> implements PortFoexMovAttributes {
  referenceDate!: string;
  movDescription!: string;
  tradeDate!: string;
  sourceSystem!: string;
  ...
  // PortFoexMov belongsTo CompanyBook via bookCode
  ...
  // PortFoexMov belongsTo CompanyCostCentre via companyCode
  ...
  // PortFoexMov belongsTo CompanyCostCentre via fundingProvider
  ...
  // PortFoexMov belongsTo CompanyCostCentre via costCentre
  ...
  // PortFoexMov belongsTo DomsAccrualBasis via accrualBasisPayLeg
  ...
  // PortFoexMov belongsTo DomsAccrualBasis via accrualBasisRecLeg
  ...
  // PortFoexMov belongsTo DomsBankingTrading via bankingTrading
  ...
  // PortFoexMov belongsTo DomsDerivativeMultiplierType via multiplierTypeRecLeg
  ...
  // PortFoexMov belongsTo DomsDerivativeMultiplierType via multiplierTypePayLeg
  ...
  // PortFoexMov belongsTo DomsGlClass via glClass
  ...
  // PortFoexMov belongsTo DomsPerformingStatus via performingStatus
  ...
  // PortFoexMov belongsTo DomsRateType via fundingRateType
  ...
  // PortFoexMov belongsTo InvptyDet via invptyCode
  ...
  // PortFoexMov belongsTo Product via productCode
  ...
  // PortFoexMov belongsTo SysCurrency via underlyingCcyPayLeg
  ...
  // PortFoexMov belongsTo SysCurrency via underlyingCcyRecLeg
  ...
  // PortFoexMov belongsTo SysCurrency via currencyRecLeg
  ...
  // PortFoexMov belongsTo SysCurrency via currencyMarketValue
  ...
  // PortFoexMov belongsTo SysCurrency via fundingCcy
  ...
  // PortFoexMov belongsTo SysCurrency via currencyPayLeg
  ...
  // PortFoexMov belongsTo SysExternalSystem via sourceSystem
  ...
  // PortFoexMov belongsTo SysUnderlying via fwdStartCorrectionUnderlying
  ...
  // PortFoexMov belongsTo SysUnderlying via fundingCurve
  ...
  // PortFoexMov belongsTo SysUnderlying via underlyingPayLeg
  ...
  // PortFoexMov belongsTo SysUnderlying via underlyingRecLeg
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortFoexMov {
    return PortFoexMov.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_foex_mov',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_FOEX_MOV",
        unique: true,
        fields: [
          { name: "reference_date" },
      ...
      {
        name: "port_foex_mov_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
