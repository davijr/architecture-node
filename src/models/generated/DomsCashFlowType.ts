...
export interface DomsCashFlowTypeAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsCashFlowTypePk = "domain";
export type DomsCashFlowTypeId = DomsCashFlowType[DomsCashFlowTypePk];
export type DomsCashFlowTypeCreationAttributes = DomsCashFlowTypeAttributes;

export class DomsCashFlowType extends Model<DomsCashFlowTypeAttributes, DomsCashFlowTypeCreationAttributes> implements DomsCashFlowTypeAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsCashFlowType hasMany PnlOperincCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortDsecCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortFincCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortFoexCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortFutuCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortLoanCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortNdfsCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortNostroCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortOtherCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortRecvCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortRepoCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortSwapCsf via cashFlowType
  ...
  // DomsCashFlowType hasMany PortVostroCsf via cashFlowType
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsCashFlowType {
    return DomsCashFlowType.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_cash_flow_type',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_cash_flow_type_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
