...
export interface PortFoexCsfAttributes {
...
export type PortFoexCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortFoexCsfId = PortFoexCsf[PortFoexCsfPk];
export type PortFoexCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortFoexCsfCreationAttributes = Optional<PortFoexCsfAttributes, PortFoexCsfOptionalAttributes>;

export class PortFoexCsf extends Model<PortFoexCsfAttributes, PortFoexCsfCreationAttributes> implements PortFoexCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortFoexCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortFoexCsf belongsTo DomsCapType via floorType
  ...
  // PortFoexCsf belongsTo DomsCapType via capType
  ...
  // PortFoexCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortFoexCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortFoexCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortFoexCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortFoexCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortFoexCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortFoexCsf belongsTo DomsPayReceive via legType
  ...
  // PortFoexCsf belongsTo DomsRateType via rateType
  ...
  // PortFoexCsf belongsTo PortFoexPos via contractReference
  contractReferencePortFoexPo!: PortFoexPos;
  getContractReferencePortFoexPo!: Sequelize.BelongsToGetAssociationMixin<PortFoexPos>;
  setContractReferencePortFoexPo!: Sequelize.BelongsToSetAssociationMixin<PortFoexPos, PortFoexPosId>;
  createContractReferencePortFoexPo!: Sequelize.BelongsToCreateAssociationMixin<PortFoexPos>;
  // PortFoexCsf belongsTo PortFoexPos via productCode
  productCodePortFoexPo!: PortFoexPos;
  getProductCodePortFoexPo!: Sequelize.BelongsToGetAssociationMixin<PortFoexPos>;
  setProductCodePortFoexPo!: Sequelize.BelongsToSetAssociationMixin<PortFoexPos, PortFoexPosId>;
  createProductCodePortFoexPo!: Sequelize.BelongsToCreateAssociationMixin<PortFoexPos>;
  // PortFoexCsf belongsTo PortFoexPos via referenceDate
  referenceDatePortFoexPo!: PortFoexPos;
  getReferenceDatePortFoexPo!: Sequelize.BelongsToGetAssociationMixin<PortFoexPos>;
  setReferenceDatePortFoexPo!: Sequelize.BelongsToSetAssociationMixin<PortFoexPos, PortFoexPosId>;
  createReferenceDatePortFoexPo!: Sequelize.BelongsToCreateAssociationMixin<PortFoexPos>;
  // PortFoexCsf belongsTo PortFoexPos via sourceSystem
  sourceSystemPortFoexPo!: PortFoexPos;
  getSourceSystemPortFoexPo!: Sequelize.BelongsToGetAssociationMixin<PortFoexPos>;
  setSourceSystemPortFoexPo!: Sequelize.BelongsToSetAssociationMixin<PortFoexPos, PortFoexPosId>;
  createSourceSystemPortFoexPo!: Sequelize.BelongsToCreateAssociationMixin<PortFoexPos>;
  // PortFoexCsf belongsTo SysCurrency via currencyCode
  ...
  // PortFoexCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortFoexCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortFoexCsf {
    return PortFoexCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_foex_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_FOEX_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_foex_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
