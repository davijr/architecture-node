...
export interface CrmGuarPosAttributes {
...
export type CrmGuarPosPk = "referenceDate" | "sourceSystem" | "productCode" | "contractReference";
export type CrmGuarPosId = CrmGuarPos[CrmGuarPosPk];
export type CrmGuarPosOptionalAttributes = "firstContractReference" | "participationFlag" | "notional" | "notionalOutstanding" | "notionalUpdateFixedRate" | "notionalUpdateIndexPercent" | "notionalUpdateTenorFrequencyUnit" | "notionalUpdateFrequencyUnit" | "notionalUpdateNextDate" | "notionalUpdateLastDate" | "accrual" | "effectiveYield" | "originalCost" | "fairValue" | "fairValueAccumChanges" | "outstanding" | "amortizedCost" | "acquisitionDate" | "unrealizedGainLoss" | "forbearanceDate" | "performingStatus" | "performingStatusChangeDate" | "pastDueDays" | "pastDueInstallments" | "pastDuePrincipal" | "pastDueInterest" | "pastDueFee" | "defaultDate" | "recoveriesSinceDefault";
export type CrmGuarPosCreationAttributes = Optional<CrmGuarPosAttributes, CrmGuarPosOptionalAttributes>;

export class CrmGuarPos extends Model<CrmGuarPosAttributes, CrmGuarPosCreationAttributes> implements CrmGuarPosAttributes {
  referenceDate!: string;
  sourceSystem!: string;
  productCode!: string;
  contractReference!: string;
  ...
  // CrmGuarPos belongsTo CompanyCostCentre via companyCode
  ...
  // CrmGuarPos belongsTo CompanyCostCentre via costCentre
  ...
  // CrmGuarPos belongsTo DomsAccrualBasis via notionalUpdateAccrualBasis
  ...
  // CrmGuarPos belongsTo DomsCalcFrequency via notionalUpdateFrequency
  ...
  // CrmGuarPos belongsTo DomsCalcFrequency via notionalUpdateTenorFrequency
  ...
  // CrmGuarPos belongsTo DomsFairValueOption via fairValueOption
  ...
  // CrmGuarPos belongsTo DomsForbearanceMeasures via forbearanceMeasures
  ...
  // CrmGuarPos belongsTo DomsParticipationFlag via participationFlag
  ...
  // CrmGuarPos belongsTo DomsPerformingStatus via performingStatus
  ...
  // CrmGuarPos belongsTo DomsRateType via notionalUpdateRateType
  ...
  // CrmGuarPos belongsTo DomsSubType via subType
  ...
  // CrmGuarPos belongsTo InvptyDet via guarantorCode
  guarantorCodeInvptyDet!: InvptyDet;
  getGuarantorCodeInvptyDet!: Sequelize.BelongsToGetAssociationMixin<InvptyDet>;
  setGuarantorCodeInvptyDet!: Sequelize.BelongsToSetAssociationMixin<InvptyDet, InvptyDetId>;
  createGuarantorCodeInvptyDet!: Sequelize.BelongsToCreateAssociationMixin<InvptyDet>;
  // CrmGuarPos belongsTo Product via productCode
  ...
  // CrmGuarPos belongsTo SysCountry via originationCountry
  ...
  // CrmGuarPos belongsTo SysCurrency via currencyCode
  ...
  // CrmGuarPos belongsTo SysExternalSystem via sourceSystem
  ...
  // CrmGuarPos belongsTo SysUnderlying via notionalUpdateIndex
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof CrmGuarPos {
    return CrmGuarPos.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'crm_guar_pos',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-CRM_GUAR_POS",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_system" },
      ...
      {
        name: "crm_guar_pos_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
