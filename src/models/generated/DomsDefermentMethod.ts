...
export interface DomsDefermentMethodAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsDefermentMethodPk = "domain";
export type DomsDefermentMethodId = DomsDefermentMethod[DomsDefermentMethodPk];
export type DomsDefermentMethodCreationAttributes = DomsDefermentMethodAttributes;

export class DomsDefermentMethod extends Model<DomsDefermentMethodAttributes, DomsDefermentMethodCreationAttributes> implements DomsDefermentMethodAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsDefermentMethod hasMany PnlOperincCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortDsecCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortFincCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortFoexCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortFutuCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortLoanCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortNdfsCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortNostroCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortOtherCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortRecvCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortRepoCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortSwapCsf via defermentMethod
  ...
  // DomsDefermentMethod hasMany PortVostroCsf via defermentMethod
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsDefermentMethod {
    return DomsDefermentMethod.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_deferment_method',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_deferment_method_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
