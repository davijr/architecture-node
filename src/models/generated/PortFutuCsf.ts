...
export interface PortFutuCsfAttributes {
...
export type PortFutuCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortFutuCsfId = PortFutuCsf[PortFutuCsfPk];
export type PortFutuCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortFutuCsfCreationAttributes = Optional<PortFutuCsfAttributes, PortFutuCsfOptionalAttributes>;

export class PortFutuCsf extends Model<PortFutuCsfAttributes, PortFutuCsfCreationAttributes> implements PortFutuCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortFutuCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortFutuCsf belongsTo DomsCapType via capType
  ...
  // PortFutuCsf belongsTo DomsCapType via floorType
  ...
  // PortFutuCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortFutuCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortFutuCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortFutuCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortFutuCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortFutuCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortFutuCsf belongsTo DomsPayReceive via legType
  ...
  // PortFutuCsf belongsTo DomsRateType via rateType
  ...
  // PortFutuCsf belongsTo PortFutuPos via companyCode
  companyCodePortFutuPo!: PortFutuPos;
  getCompanyCodePortFutuPo!: Sequelize.BelongsToGetAssociationMixin<PortFutuPos>;
  setCompanyCodePortFutuPo!: Sequelize.BelongsToSetAssociationMixin<PortFutuPos, PortFutuPosId>;
  createCompanyCodePortFutuPo!: Sequelize.BelongsToCreateAssociationMixin<PortFutuPos>;
  // PortFutuCsf belongsTo PortFutuPos via contractReference
  contractReferencePortFutuPo!: PortFutuPos;
  getContractReferencePortFutuPo!: Sequelize.BelongsToGetAssociationMixin<PortFutuPos>;
  setContractReferencePortFutuPo!: Sequelize.BelongsToSetAssociationMixin<PortFutuPos, PortFutuPosId>;
  createContractReferencePortFutuPo!: Sequelize.BelongsToCreateAssociationMixin<PortFutuPos>;
  // PortFutuCsf belongsTo PortFutuPos via productCode
  productCodePortFutuPo!: PortFutuPos;
  getProductCodePortFutuPo!: Sequelize.BelongsToGetAssociationMixin<PortFutuPos>;
  setProductCodePortFutuPo!: Sequelize.BelongsToSetAssociationMixin<PortFutuPos, PortFutuPosId>;
  createProductCodePortFutuPo!: Sequelize.BelongsToCreateAssociationMixin<PortFutuPos>;
  // PortFutuCsf belongsTo PortFutuPos via referenceDate
  referenceDatePortFutuPo!: PortFutuPos;
  getReferenceDatePortFutuPo!: Sequelize.BelongsToGetAssociationMixin<PortFutuPos>;
  setReferenceDatePortFutuPo!: Sequelize.BelongsToSetAssociationMixin<PortFutuPos, PortFutuPosId>;
  createReferenceDatePortFutuPo!: Sequelize.BelongsToCreateAssociationMixin<PortFutuPos>;
  // PortFutuCsf belongsTo PortFutuPos via sourceSystem
  sourceSystemPortFutuPo!: PortFutuPos;
  getSourceSystemPortFutuPo!: Sequelize.BelongsToGetAssociationMixin<PortFutuPos>;
  setSourceSystemPortFutuPo!: Sequelize.BelongsToSetAssociationMixin<PortFutuPos, PortFutuPosId>;
  createSourceSystemPortFutuPo!: Sequelize.BelongsToCreateAssociationMixin<PortFutuPos>;
  // PortFutuCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortFutuCsf belongsTo SysCurrency via currencyCode
  ...
  // PortFutuCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortFutuCsf {
    return PortFutuCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_futu_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_FUTU_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_futu_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
