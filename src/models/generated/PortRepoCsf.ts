...
export interface PortRepoCsfAttributes {
...
export type PortRepoCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortRepoCsfId = PortRepoCsf[PortRepoCsfPk];
export type PortRepoCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortRepoCsfCreationAttributes = Optional<PortRepoCsfAttributes, PortRepoCsfOptionalAttributes>;

export class PortRepoCsf extends Model<PortRepoCsfAttributes, PortRepoCsfCreationAttributes> implements PortRepoCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortRepoCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortRepoCsf belongsTo DomsCapType via floorType
  ...
  // PortRepoCsf belongsTo DomsCapType via capType
  ...
  // PortRepoCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortRepoCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortRepoCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortRepoCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortRepoCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortRepoCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortRepoCsf belongsTo DomsPayReceive via legType
  ...
  // PortRepoCsf belongsTo DomsRateType via rateType
  ...
  // PortRepoCsf belongsTo PortRepoPos via contractReference
  ...
  // PortRepoCsf belongsTo PortRepoPos via productCode
  ...
  // PortRepoCsf belongsTo PortRepoPos via referenceDate
  ...
  // PortRepoCsf belongsTo PortRepoPos via sourceSystem
  ...
  // PortRepoCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortRepoCsf belongsTo SysCurrency via currencyCode
  ...
  // PortRepoCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortRepoCsf {
    return PortRepoCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_repo_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_REPO_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_repo_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
