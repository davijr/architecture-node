...
export interface PortOtherCsfAttributes {
...
export type PortOtherCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortOtherCsfId = PortOtherCsf[PortOtherCsfPk];
export type PortOtherCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortOtherCsfCreationAttributes = Optional<PortOtherCsfAttributes, PortOtherCsfOptionalAttributes>;

export class PortOtherCsf extends Model<PortOtherCsfAttributes, PortOtherCsfCreationAttributes> implements PortOtherCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortOtherCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortOtherCsf belongsTo DomsCapType via floorType
  ...
  // PortOtherCsf belongsTo DomsCapType via capType
  ...
  // PortOtherCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortOtherCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortOtherCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortOtherCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortOtherCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortOtherCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortOtherCsf belongsTo DomsPayReceive via legType
  ...
  // PortOtherCsf belongsTo DomsRateType via rateType
  ...
  // PortOtherCsf belongsTo PortOtherPos via companyCode
  companyCodePortOtherPo!: PortOtherPos;
  getCompanyCodePortOtherPo!: Sequelize.BelongsToGetAssociationMixin<PortOtherPos>;
  setCompanyCodePortOtherPo!: Sequelize.BelongsToSetAssociationMixin<PortOtherPos, PortOtherPosId>;
  createCompanyCodePortOtherPo!: Sequelize.BelongsToCreateAssociationMixin<PortOtherPos>;
  // PortOtherCsf belongsTo PortOtherPos via contractReference
  contractReferencePortOtherPo!: PortOtherPos;
  getContractReferencePortOtherPo!: Sequelize.BelongsToGetAssociationMixin<PortOtherPos>;
  setContractReferencePortOtherPo!: Sequelize.BelongsToSetAssociationMixin<PortOtherPos, PortOtherPosId>;
  createContractReferencePortOtherPo!: Sequelize.BelongsToCreateAssociationMixin<PortOtherPos>;
  // PortOtherCsf belongsTo PortOtherPos via productCode
  productCodePortOtherPo!: PortOtherPos;
  getProductCodePortOtherPo!: Sequelize.BelongsToGetAssociationMixin<PortOtherPos>;
  setProductCodePortOtherPo!: Sequelize.BelongsToSetAssociationMixin<PortOtherPos, PortOtherPosId>;
  createProductCodePortOtherPo!: Sequelize.BelongsToCreateAssociationMixin<PortOtherPos>;
  // PortOtherCsf belongsTo PortOtherPos via referenceDate
  referenceDatePortOtherPo!: PortOtherPos;
  getReferenceDatePortOtherPo!: Sequelize.BelongsToGetAssociationMixin<PortOtherPos>;
  setReferenceDatePortOtherPo!: Sequelize.BelongsToSetAssociationMixin<PortOtherPos, PortOtherPosId>;
  createReferenceDatePortOtherPo!: Sequelize.BelongsToCreateAssociationMixin<PortOtherPos>;
  // PortOtherCsf belongsTo PortOtherPos via sourceSystem
  sourceSystemPortOtherPo!: PortOtherPos;
  getSourceSystemPortOtherPo!: Sequelize.BelongsToGetAssociationMixin<PortOtherPos>;
  setSourceSystemPortOtherPo!: Sequelize.BelongsToSetAssociationMixin<PortOtherPos, PortOtherPosId>;
  createSourceSystemPortOtherPo!: Sequelize.BelongsToCreateAssociationMixin<PortOtherPos>;
  // PortOtherCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortOtherCsf belongsTo SysCurrency via currencyCode
  ...
  // PortOtherCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortOtherCsf {
    return PortOtherCsf.init({
    referenceDate: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      primaryKey: true,
      references: {
        model: 'port_other_pos',
        key: 'source_system'
      },
    ...
    sequelize,
    tableName: 'port_other_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_OTHER_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_other_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
