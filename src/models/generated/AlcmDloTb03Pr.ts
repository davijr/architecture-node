...
export interface AlcmDloTb03PrAttributes {
  dloAccount: string;
...
export type AlcmDloTb03PrPk = "dloAccount";
export type AlcmDloTb03PrId = AlcmDloTb03Pr[AlcmDloTb03PrPk];
export type AlcmDloTb03PrOptionalAttributes = "dloDomainEndDate" | "dloDerivedFormula";
export type AlcmDloTb03PrCreationAttributes = Optional<AlcmDloTb03PrAttributes, AlcmDloTb03PrOptionalAttributes>;

export class AlcmDloTb03Pr extends Model<AlcmDloTb03PrAttributes, AlcmDloTb03PrCreationAttributes> implements AlcmDloTb03PrAttributes {
  dloAccount!: string;
  dloDomainDescription!: string;
  dloDomainInitialDate!: string;
  dloDomainEndDate?: string;
  ...
  // AlcmDloTb03Pr belongsTo AlcmDloAcctGroup via dloAccountGroup
  ...
  // AlcmDloTb03Pr hasMany AlcmCapitalAccountParam via dloAccountPr
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof AlcmDloTb03Pr {
    return AlcmDloTb03Pr.init({
    dloAccount: {
    ...
    sequelize,
    tableName: 'alcm_dlo_tb03_pr',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-ALCM_DLO_TB03_PR",
        unique: true,
        fields: [
          { name: "dlo_account" },
        ]
