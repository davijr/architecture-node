...
export interface PortVostroCsfAttributes {
...
export type PortVostroCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortVostroCsfId = PortVostroCsf[PortVostroCsfPk];
export type PortVostroCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortVostroCsfCreationAttributes = Optional<PortVostroCsfAttributes, PortVostroCsfOptionalAttributes>;

export class PortVostroCsf extends Model<PortVostroCsfAttributes, PortVostroCsfCreationAttributes> implements PortVostroCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortVostroCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortVostroCsf belongsTo DomsCapType via capType
  ...
  // PortVostroCsf belongsTo DomsCapType via floorType
  ...
  // PortVostroCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortVostroCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortVostroCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortVostroCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortVostroCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortVostroCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortVostroCsf belongsTo DomsPayReceive via legType
  ...
  // PortVostroCsf belongsTo DomsRateType via rateType
  ...
  // PortVostroCsf belongsTo PortVostroPos via companyCode
  companyCodePortVostroPo!: PortVostroPos;
  getCompanyCodePortVostroPo!: Sequelize.BelongsToGetAssociationMixin<PortVostroPos>;
  setCompanyCodePortVostroPo!: Sequelize.BelongsToSetAssociationMixin<PortVostroPos, PortVostroPosId>;
  createCompanyCodePortVostroPo!: Sequelize.BelongsToCreateAssociationMixin<PortVostroPos>;
  // PortVostroCsf belongsTo PortVostroPos via contractReference
  contractReferencePortVostroPo!: PortVostroPos;
  getContractReferencePortVostroPo!: Sequelize.BelongsToGetAssociationMixin<PortVostroPos>;
  setContractReferencePortVostroPo!: Sequelize.BelongsToSetAssociationMixin<PortVostroPos, PortVostroPosId>;
  createContractReferencePortVostroPo!: Sequelize.BelongsToCreateAssociationMixin<PortVostroPos>;
  // PortVostroCsf belongsTo PortVostroPos via productCode
  productCodePortVostroPo!: PortVostroPos;
  getProductCodePortVostroPo!: Sequelize.BelongsToGetAssociationMixin<PortVostroPos>;
  setProductCodePortVostroPo!: Sequelize.BelongsToSetAssociationMixin<PortVostroPos, PortVostroPosId>;
  createProductCodePortVostroPo!: Sequelize.BelongsToCreateAssociationMixin<PortVostroPos>;
  // PortVostroCsf belongsTo PortVostroPos via referenceDate
  referenceDatePortVostroPo!: PortVostroPos;
  getReferenceDatePortVostroPo!: Sequelize.BelongsToGetAssociationMixin<PortVostroPos>;
  setReferenceDatePortVostroPo!: Sequelize.BelongsToSetAssociationMixin<PortVostroPos, PortVostroPosId>;
  createReferenceDatePortVostroPo!: Sequelize.BelongsToCreateAssociationMixin<PortVostroPos>;
  // PortVostroCsf belongsTo PortVostroPos via sourceSystem
  sourceSystemPortVostroPo!: PortVostroPos;
  getSourceSystemPortVostroPo!: Sequelize.BelongsToGetAssociationMixin<PortVostroPos>;
  setSourceSystemPortVostroPo!: Sequelize.BelongsToSetAssociationMixin<PortVostroPos, PortVostroPosId>;
  createSourceSystemPortVostroPo!: Sequelize.BelongsToCreateAssociationMixin<PortVostroPos>;
  // PortVostroCsf belongsTo SysCurrency via currencyCode
  ...
  // PortVostroCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortVostroCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortVostroCsf {
    return PortVostroCsf.init({
    referenceDate: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      primaryKey: true,
      references: {
        model: 'port_vostro_pos',
        key: 'source_system'
      },
    ...
    sequelize,
    tableName: 'port_vostro_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_VOSTRO_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_vostro_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
