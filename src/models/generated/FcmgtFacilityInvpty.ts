...
export interface FcmgtFacilityInvptyAttributes {
...
export class FcmgtFacilityInvpty extends Model<FcmgtFacilityInvptyAttributes, FcmgtFacilityInvptyCreationAttributes> implements FcmgtFacilityInvptyAttributes {
  ...
  // FcmgtFacilityInvpty belongsTo FcmgtFacilityCode via facilityCode
  ...
  // FcmgtFacilityInvpty belongsTo InvptyDet via invptyCode
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof FcmgtFacilityInvpty {
    return FcmgtFacilityInvpty.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'fcmgt_facility_invpty',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-FCMGT_FACILITY_INVPTY",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "facility_code" },
