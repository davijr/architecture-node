...
export interface DomsCashFlowApproachAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsCashFlowApproachPk = "domain";
export type DomsCashFlowApproachId = DomsCashFlowApproach[DomsCashFlowApproachPk];
export type DomsCashFlowApproachCreationAttributes = DomsCashFlowApproachAttributes;

export class DomsCashFlowApproach extends Model<DomsCashFlowApproachAttributes, DomsCashFlowApproachCreationAttributes> implements DomsCashFlowApproachAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsCashFlowApproach hasMany PnlOperincCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortDsecCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortFincCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortFoexCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortFutuCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortLoanCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortNdfsCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortNostroCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortOtherCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortRecvCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortRepoCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortSwapCsf via cashFlowApproach
  ...
  // DomsCashFlowApproach hasMany PortVostroCsf via cashFlowApproach
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsCashFlowApproach {
    return DomsCashFlowApproach.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_cash_flow_approach',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_cash_flow_approach_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
      ...
      {
        name: "pk_doms_cash_flow_approach",
        unique: true,
        fields: [
          { name: "domain" },
        ]
