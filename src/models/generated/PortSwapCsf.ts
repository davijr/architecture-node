...
export interface PortSwapCsfAttributes {
...
export type PortSwapCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortSwapCsfId = PortSwapCsf[PortSwapCsfPk];
export type PortSwapCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "cashFlowFutureValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortSwapCsfCreationAttributes = Optional<PortSwapCsfAttributes, PortSwapCsfOptionalAttributes>;

export class PortSwapCsf extends Model<PortSwapCsfAttributes, PortSwapCsfCreationAttributes> implements PortSwapCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortSwapCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortSwapCsf belongsTo DomsCapType via capType
  ...
  // PortSwapCsf belongsTo DomsCapType via floorType
  ...
  // PortSwapCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortSwapCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortSwapCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortSwapCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortSwapCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortSwapCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortSwapCsf belongsTo DomsPayReceive via legType
  ...
  // PortSwapCsf belongsTo DomsRateType via rateType
  ...
  // PortSwapCsf belongsTo PortSwapPos via contractReference
  contractReferencePortSwapPo!: PortSwapPos;
  getContractReferencePortSwapPo!: Sequelize.BelongsToGetAssociationMixin<PortSwapPos>;
  setContractReferencePortSwapPo!: Sequelize.BelongsToSetAssociationMixin<PortSwapPos, PortSwapPosId>;
  createContractReferencePortSwapPo!: Sequelize.BelongsToCreateAssociationMixin<PortSwapPos>;
  // PortSwapCsf belongsTo PortSwapPos via productCode
  productCodePortSwapPo!: PortSwapPos;
  getProductCodePortSwapPo!: Sequelize.BelongsToGetAssociationMixin<PortSwapPos>;
  setProductCodePortSwapPo!: Sequelize.BelongsToSetAssociationMixin<PortSwapPos, PortSwapPosId>;
  createProductCodePortSwapPo!: Sequelize.BelongsToCreateAssociationMixin<PortSwapPos>;
  // PortSwapCsf belongsTo PortSwapPos via referenceDate
  referenceDatePortSwapPo!: PortSwapPos;
  getReferenceDatePortSwapPo!: Sequelize.BelongsToGetAssociationMixin<PortSwapPos>;
  setReferenceDatePortSwapPo!: Sequelize.BelongsToSetAssociationMixin<PortSwapPos, PortSwapPosId>;
  createReferenceDatePortSwapPo!: Sequelize.BelongsToCreateAssociationMixin<PortSwapPos>;
  // PortSwapCsf belongsTo PortSwapPos via sourceSystem
  sourceSystemPortSwapPo!: PortSwapPos;
  getSourceSystemPortSwapPo!: Sequelize.BelongsToGetAssociationMixin<PortSwapPos>;
  setSourceSystemPortSwapPo!: Sequelize.BelongsToSetAssociationMixin<PortSwapPos, PortSwapPosId>;
  createSourceSystemPortSwapPo!: Sequelize.BelongsToCreateAssociationMixin<PortSwapPos>;
  // PortSwapCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortSwapCsf belongsTo SysCurrency via currencyCode
  ...
  // PortSwapCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortSwapCsf {
    return PortSwapCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_swap_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_SWAP_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_swap_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
