...
export interface AlcmDloTb03OpadAttributes {
  dloAccount: string;
...
export type AlcmDloTb03OpadPk = "dloAccount";
export type AlcmDloTb03OpadId = AlcmDloTb03Opad[AlcmDloTb03OpadPk];
export type AlcmDloTb03OpadOptionalAttributes = "dloDomainEndDate" | "dloDerivedFormula";
export type AlcmDloTb03OpadCreationAttributes = Optional<AlcmDloTb03OpadAttributes, AlcmDloTb03OpadOptionalAttributes>;

export class AlcmDloTb03Opad extends Model<AlcmDloTb03OpadAttributes, AlcmDloTb03OpadCreationAttributes> implements AlcmDloTb03OpadAttributes {
  dloAccount!: string;
  dloDomainDescription!: string;
  dloDomainInitialDate!: string;
  dloDomainEndDate?: string;
  ...
  // AlcmDloTb03Opad belongsTo AlcmDloAcctGroup via dloAccountGroup
  ...
  // AlcmDloTb03Opad hasMany AlcmCapitalAccountParam via dloAccountOpad
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof AlcmDloTb03Opad {
    return AlcmDloTb03Opad.init({
    dloAccount: {
    ...
    sequelize,
    tableName: 'alcm_dlo_tb03_opad',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-ALCM_DLO_TB03_OPAD",
        unique: true,
        fields: [
          { name: "dlo_account" },
        ]
