...
export interface PortNdfsMovAttributes {
...
export class PortNdfsMov extends Model<PortNdfsMovAttributes, PortNdfsMovCreationAttributes> implements PortNdfsMovAttributes {
  ...
  // PortNdfsMov belongsTo CompanyBook via bookCode
  ...
  // PortNdfsMov belongsTo CompanyCostCentre via companyCode
  ...
  // PortNdfsMov belongsTo CompanyCostCentre via fundingProvider
  ...
  // PortNdfsMov belongsTo CompanyCostCentre via costCentre
  ...
  // PortNdfsMov belongsTo DomsAccrualBasis via accrualBasisRecLeg
  ...
  // PortNdfsMov belongsTo DomsAccrualBasis via accrualBasisPayLeg
  ...
  // PortNdfsMov belongsTo DomsBankingTrading via bankingTrading
  ...
  // PortNdfsMov belongsTo DomsDerivativeMultiplierType via multiplierTypeRecLeg
  ...
  // PortNdfsMov belongsTo DomsDerivativeMultiplierType via multiplierTypePayLeg
  ...
  // PortNdfsMov belongsTo DomsGlClass via glClass
  ...
  // PortNdfsMov belongsTo DomsPerformingStatus via performingStatus
  ...
  // PortNdfsMov belongsTo DomsRateType via fundingRateType
  ...
  // PortNdfsMov belongsTo InvptyDet via invptyCode
  ...
  // PortNdfsMov belongsTo Product via productCode
  ...
  // PortNdfsMov belongsTo SysCurrency via underlyingCcyPayLeg
  ...
  // PortNdfsMov belongsTo SysCurrency via underlyingCcyRecLeg
  ...
  // PortNdfsMov belongsTo SysCurrency via currencyRecLeg
  ...
  // PortNdfsMov belongsTo SysCurrency via currencyMarketValue
  ...
  // PortNdfsMov belongsTo SysCurrency via fundingCcy
  ...
  // PortNdfsMov belongsTo SysCurrency via currencyPayLeg
  ...
  // PortNdfsMov belongsTo SysExternalSystem via sourceSystem
  ...
  // PortNdfsMov belongsTo SysUnderlying via underlyingPayLeg
  ...
  // PortNdfsMov belongsTo SysUnderlying via underlyingRecLeg
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortNdfsMov {
    return PortNdfsMov.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_ndfs_mov',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_NDFS_MOV",
        unique: true,
        fields: [
          { name: "reference_date" },
      ...
      {
        name: "port_ndfs_mov_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
