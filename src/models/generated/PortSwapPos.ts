...
export interface PortSwapPosAttributes {
...
export class PortSwapPos extends Model<PortSwapPosAttributes, PortSwapPosCreationAttributes> implements PortSwapPosAttributes {
  ...
  // PortSwapPos belongsTo CompanyBook via bookCode
  ...
  // PortSwapPos belongsTo CompanyCostCentre via companyCode
  ...
  // PortSwapPos belongsTo CompanyCostCentre via fundingProvider
  ...
  // PortSwapPos belongsTo CompanyCostCentre via costCentre
  ...
  // PortSwapPos belongsTo DomsAccrualBasis via accrualBasisPayLeg
  ...
  // PortSwapPos belongsTo DomsAccrualBasis via accrualBasisRecLeg
  ...
  // PortSwapPos belongsTo DomsBankingTrading via bankingTrading
  ...
  // PortSwapPos belongsTo DomsDerivativeMultiplierType via multiplierTypeRecLeg
  ...
  // PortSwapPos belongsTo DomsDerivativeMultiplierType via multiplierTypePayLeg
  ...
  // PortSwapPos belongsTo DomsGlClass via glClass
  ...
  // PortSwapPos belongsTo DomsPerformingStatus via performingStatus
  ...
  // PortSwapPos belongsTo DomsRateType via fundingRateType
  ...
  // PortSwapPos belongsTo InvptyDet via invptyCode
  ...
  // PortSwapPos hasMany PortSwapCsf via contractReference
  ...
  // PortSwapPos hasMany PortSwapCsf via productCode
  productCodePortSwapCsfs!: PortSwapCsf[];
  getProductCodePortSwapCsfs!: Sequelize.HasManyGetAssociationsMixin<PortSwapCsf>;
  setProductCodePortSwapCsfs!: Sequelize.HasManySetAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  addProductCodePortSwapCsf!: Sequelize.HasManyAddAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  addProductCodePortSwapCsfs!: Sequelize.HasManyAddAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  createProductCodePortSwapCsf!: Sequelize.HasManyCreateAssociationMixin<PortSwapCsf>;
  removeProductCodePortSwapCsf!: Sequelize.HasManyRemoveAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  removeProductCodePortSwapCsfs!: Sequelize.HasManyRemoveAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  hasProductCodePortSwapCsf!: Sequelize.HasManyHasAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  hasProductCodePortSwapCsfs!: Sequelize.HasManyHasAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  countProductCodePortSwapCsfs!: Sequelize.HasManyCountAssociationsMixin;
  // PortSwapPos hasMany PortSwapCsf via referenceDate
  referenceDatePortSwapCsfs!: PortSwapCsf[];
  getReferenceDatePortSwapCsfs!: Sequelize.HasManyGetAssociationsMixin<PortSwapCsf>;
  setReferenceDatePortSwapCsfs!: Sequelize.HasManySetAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  addReferenceDatePortSwapCsf!: Sequelize.HasManyAddAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  addReferenceDatePortSwapCsfs!: Sequelize.HasManyAddAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  createReferenceDatePortSwapCsf!: Sequelize.HasManyCreateAssociationMixin<PortSwapCsf>;
  removeReferenceDatePortSwapCsf!: Sequelize.HasManyRemoveAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  removeReferenceDatePortSwapCsfs!: Sequelize.HasManyRemoveAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  hasReferenceDatePortSwapCsf!: Sequelize.HasManyHasAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  hasReferenceDatePortSwapCsfs!: Sequelize.HasManyHasAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  countReferenceDatePortSwapCsfs!: Sequelize.HasManyCountAssociationsMixin;
  // PortSwapPos hasMany PortSwapCsf via sourceSystem
  sourceSystemPortSwapCsfs!: PortSwapCsf[];
  getSourceSystemPortSwapCsfs!: Sequelize.HasManyGetAssociationsMixin<PortSwapCsf>;
  setSourceSystemPortSwapCsfs!: Sequelize.HasManySetAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  addSourceSystemPortSwapCsf!: Sequelize.HasManyAddAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  addSourceSystemPortSwapCsfs!: Sequelize.HasManyAddAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  createSourceSystemPortSwapCsf!: Sequelize.HasManyCreateAssociationMixin<PortSwapCsf>;
  removeSourceSystemPortSwapCsf!: Sequelize.HasManyRemoveAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  removeSourceSystemPortSwapCsfs!: Sequelize.HasManyRemoveAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  hasSourceSystemPortSwapCsf!: Sequelize.HasManyHasAssociationMixin<PortSwapCsf, PortSwapCsfId>;
  hasSourceSystemPortSwapCsfs!: Sequelize.HasManyHasAssociationsMixin<PortSwapCsf, PortSwapCsfId>;
  countSourceSystemPortSwapCsfs!: Sequelize.HasManyCountAssociationsMixin;
  // PortSwapPos belongsTo Product via productCode
  ...
  // PortSwapPos belongsTo SysCurrency via currencyMarketValue
  ...
  // PortSwapPos belongsTo SysCurrency via currencyPayLeg
  ...
  // PortSwapPos belongsTo SysCurrency via currencyRecLeg
  ...
  // PortSwapPos belongsTo SysCurrency via fundingCcy
  ...
  // PortSwapPos belongsTo SysCurrency via underlyingCcyPayLeg
  ...
  // PortSwapPos belongsTo SysCurrency via underlyingCcyRecLeg
  ...
  // PortSwapPos belongsTo SysExternalSystem via sourceSystem
  ...
  // PortSwapPos belongsTo SysUnderlying via underlyingPayLeg
  ...
  // PortSwapPos belongsTo SysUnderlying via fwdStartCorrectionUnderlying
  ...
  // PortSwapPos belongsTo SysUnderlying via fundingCurve
  ...
  // PortSwapPos belongsTo SysUnderlying via underlyingRecLeg
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortSwapPos {
    return PortSwapPos.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_swap_pos',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_SWAP_POS",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_system" },
      ...
      {
        name: "port_swap_pos_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
