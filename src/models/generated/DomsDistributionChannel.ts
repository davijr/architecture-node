...
export interface DomsDistributionChannelAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsDistributionChannelPk = "domain";
export type DomsDistributionChannelId = DomsDistributionChannel[DomsDistributionChannelPk];
export type DomsDistributionChannelCreationAttributes = DomsDistributionChannelAttributes;

export class DomsDistributionChannel extends Model<DomsDistributionChannelAttributes, DomsDistributionChannelCreationAttributes> implements DomsDistributionChannelAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsDistributionChannel hasMany PortDsecMov via distributionChannel
  ...
  // DomsDistributionChannel hasMany PortDsecPos via distributionChannel
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsDistributionChannel {
    return DomsDistributionChannel.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_distribution_channel',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_distribution_channel_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
      ...
      {
        name: "pk_doms_distribution_channel",
        unique: true,
        fields: [
          { name: "domain" },
        ]
