...
export interface PortNdfsCsfAttributes {
...
export type PortNdfsCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortNdfsCsfId = PortNdfsCsf[PortNdfsCsfPk];
export type PortNdfsCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortNdfsCsfCreationAttributes = Optional<PortNdfsCsfAttributes, PortNdfsCsfOptionalAttributes>;

export class PortNdfsCsf extends Model<PortNdfsCsfAttributes, PortNdfsCsfCreationAttributes> implements PortNdfsCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortNdfsCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortNdfsCsf belongsTo DomsCapType via floorType
  ...
  // PortNdfsCsf belongsTo DomsCapType via capType
  ...
  // PortNdfsCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortNdfsCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortNdfsCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortNdfsCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortNdfsCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortNdfsCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortNdfsCsf belongsTo DomsPayReceive via legType
  ...
  // PortNdfsCsf belongsTo DomsRateType via rateType
  ...
  // PortNdfsCsf belongsTo PortNdfsPos via contractReference
  contractReferencePortNdfsPo!: PortNdfsPos;
  getContractReferencePortNdfsPo!: Sequelize.BelongsToGetAssociationMixin<PortNdfsPos>;
  setContractReferencePortNdfsPo!: Sequelize.BelongsToSetAssociationMixin<PortNdfsPos, PortNdfsPosId>;
  createContractReferencePortNdfsPo!: Sequelize.BelongsToCreateAssociationMixin<PortNdfsPos>;
  // PortNdfsCsf belongsTo PortNdfsPos via productCode
  productCodePortNdfsPo!: PortNdfsPos;
  getProductCodePortNdfsPo!: Sequelize.BelongsToGetAssociationMixin<PortNdfsPos>;
  setProductCodePortNdfsPo!: Sequelize.BelongsToSetAssociationMixin<PortNdfsPos, PortNdfsPosId>;
  createProductCodePortNdfsPo!: Sequelize.BelongsToCreateAssociationMixin<PortNdfsPos>;
  // PortNdfsCsf belongsTo PortNdfsPos via referenceDate
  referenceDatePortNdfsPo!: PortNdfsPos;
  getReferenceDatePortNdfsPo!: Sequelize.BelongsToGetAssociationMixin<PortNdfsPos>;
  setReferenceDatePortNdfsPo!: Sequelize.BelongsToSetAssociationMixin<PortNdfsPos, PortNdfsPosId>;
  createReferenceDatePortNdfsPo!: Sequelize.BelongsToCreateAssociationMixin<PortNdfsPos>;
  // PortNdfsCsf belongsTo PortNdfsPos via sourceSystem
  sourceSystemPortNdfsPo!: PortNdfsPos;
  getSourceSystemPortNdfsPo!: Sequelize.BelongsToGetAssociationMixin<PortNdfsPos>;
  setSourceSystemPortNdfsPo!: Sequelize.BelongsToSetAssociationMixin<PortNdfsPos, PortNdfsPosId>;
  createSourceSystemPortNdfsPo!: Sequelize.BelongsToCreateAssociationMixin<PortNdfsPos>;
  // PortNdfsCsf belongsTo SysCurrency via currencyCode
  ...
  // PortNdfsCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortNdfsCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortNdfsCsf {
    return PortNdfsCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_ndfs_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_NDFS_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_ndfs_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
