...
export interface PortDsecCsfAttributes {
...
export type PortDsecCsfPk = "referenceDate" | "sourceTable" | "sourceSystem" | "companyCode" | "productCode" | "contractReference" | "cashFlowReference" | "cashFlowType" | "legType";
export type PortDsecCsfId = PortDsecCsf[PortDsecCsfPk];
export type PortDsecCsfOptionalAttributes = "cashFlowType" | "cashFlowQuality" | "discountFactor" | "rateValue" | "marketSpread" | "initialYield" | "beginDate" | "endDate" | "accrualNbDays" | "businessNbDays" | "outstanding" | "cashFlowNotional" | "notionalFxRate" | "cashFlowFutureValue" | "cashFlowMarketValue" | "cashFlowApproach" | "premiumDiscount" | "cap" | "floor" | "fundingFlowCost" | "fundingFlowAmountFtp" | "fixingNextDate" | "fixingSettlementDate" | "defermentMethod" | "defermentContext" | "defermentRate" | "notionalPercentage" | "outstandingPercentage" | "maxAmount" | "commissionName" | "tenor";
export type PortDsecCsfCreationAttributes = Optional<PortDsecCsfAttributes, PortDsecCsfOptionalAttributes>;

export class PortDsecCsf extends Model<PortDsecCsfAttributes, PortDsecCsfCreationAttributes> implements PortDsecCsfAttributes {
  referenceDate!: string;
  sourceTable!: string;
  sourceSystem!: string;
  companyCode!: string;
  ...
  // PortDsecCsf belongsTo DomsAccrualBasis via accrualBasis
  ...
  // PortDsecCsf belongsTo DomsCapType via floorType
  ...
  // PortDsecCsf belongsTo DomsCapType via capType
  ...
  // PortDsecCsf belongsTo DomsCashFlowApproach via cashFlowApproach
  ...
  // PortDsecCsf belongsTo DomsCashFlowQuality via cashFlowQuality
  ...
  // PortDsecCsf belongsTo DomsCashFlowType via cashFlowType
  ...
  // PortDsecCsf belongsTo DomsDefermentContext via defermentContext
  ...
  // PortDsecCsf belongsTo DomsDefermentMethod via defermentMethod
  ...
  // PortDsecCsf belongsTo DomsIncomeType via incomeType
  ...
  // PortDsecCsf belongsTo DomsPayReceive via legType
  ...
  // PortDsecCsf belongsTo DomsRateType via rateType
  ...
  // PortDsecCsf belongsTo PortDsecPos via contractReference
  contractReferencePortDsecPo!: PortDsecPos;
  getContractReferencePortDsecPo!: Sequelize.BelongsToGetAssociationMixin<PortDsecPos>;
  setContractReferencePortDsecPo!: Sequelize.BelongsToSetAssociationMixin<PortDsecPos, PortDsecPosId>;
  createContractReferencePortDsecPo!: Sequelize.BelongsToCreateAssociationMixin<PortDsecPos>;
  // PortDsecCsf belongsTo PortDsecPos via productCode
  productCodePortDsecPo!: PortDsecPos;
  getProductCodePortDsecPo!: Sequelize.BelongsToGetAssociationMixin<PortDsecPos>;
  setProductCodePortDsecPo!: Sequelize.BelongsToSetAssociationMixin<PortDsecPos, PortDsecPosId>;
  createProductCodePortDsecPo!: Sequelize.BelongsToCreateAssociationMixin<PortDsecPos>;
  // PortDsecCsf belongsTo PortDsecPos via referenceDate
  referenceDatePortDsecPo!: PortDsecPos;
  getReferenceDatePortDsecPo!: Sequelize.BelongsToGetAssociationMixin<PortDsecPos>;
  setReferenceDatePortDsecPo!: Sequelize.BelongsToSetAssociationMixin<PortDsecPos, PortDsecPosId>;
  createReferenceDatePortDsecPo!: Sequelize.BelongsToCreateAssociationMixin<PortDsecPos>;
  // PortDsecCsf belongsTo PortDsecPos via sourceSystem
  sourceSystemPortDsecPo!: PortDsecPos;
  getSourceSystemPortDsecPo!: Sequelize.BelongsToGetAssociationMixin<PortDsecPos>;
  setSourceSystemPortDsecPo!: Sequelize.BelongsToSetAssociationMixin<PortDsecPos, PortDsecPosId>;
  createSourceSystemPortDsecPo!: Sequelize.BelongsToCreateAssociationMixin<PortDsecPos>;
  // PortDsecCsf belongsTo SysCurrency via currencyCode
  ...
  // PortDsecCsf belongsTo SysCurrency via notionalCurrency
  ...
  // PortDsecCsf belongsTo SysUnderlying via curveName
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PortDsecCsf {
    return PortDsecCsf.init({
    referenceDate: {
    ...
    sequelize,
    tableName: 'port_dsec_csf',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "PK-PORT_DSEC_CSF",
        unique: true,
        fields: [
          { name: "reference_date" },
          { name: "source_table" },
      ...
      {
        name: "port_dsec_csf_reference_date",
        fields: [
          { name: "reference_date" },
        ]
      },
