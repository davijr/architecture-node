...
export interface DomsDefermentContextAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsDefermentContextPk = "domain";
export type DomsDefermentContextId = DomsDefermentContext[DomsDefermentContextPk];
export type DomsDefermentContextCreationAttributes = DomsDefermentContextAttributes;

export class DomsDefermentContext extends Model<DomsDefermentContextAttributes, DomsDefermentContextCreationAttributes> implements DomsDefermentContextAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsDefermentContext hasMany PnlOperincCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortDsecCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortFincCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortFoexCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortFutuCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortLoanCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortNdfsCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortNostroCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortOtherCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortRecvCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortRepoCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortSwapCsf via defermentContext
  ...
  // DomsDefermentContext hasMany PortVostroCsf via defermentContext
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsDefermentContext {
    return DomsDefermentContext.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_deferment_context',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_deferment_context_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
      ...
      {
        name: "pk_doms_deferment_context",
        unique: true,
        fields: [
          { name: "domain" },
        ]
