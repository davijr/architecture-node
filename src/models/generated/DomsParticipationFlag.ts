...
export interface DomsParticipationFlagAttributes {
  domain: string;
  domainDesc: string;
}

export type DomsParticipationFlagPk = "domain";
export type DomsParticipationFlagId = DomsParticipationFlag[DomsParticipationFlagPk];
export type DomsParticipationFlagCreationAttributes = DomsParticipationFlagAttributes;

export class DomsParticipationFlag extends Model<DomsParticipationFlagAttributes, DomsParticipationFlagCreationAttributes> implements DomsParticipationFlagAttributes {
  domain!: string;
  domainDesc!: string;

  // DomsParticipationFlag hasMany CrmGuarPos via participationFlag
  ...
  // DomsParticipationFlag hasMany PortFctyMov via participationFlag
  ...
  // DomsParticipationFlag hasMany PortFctyPos via participationFlag
  ...
  // DomsParticipationFlag hasMany PortGuarMov via participationFlag
  ...
  // DomsParticipationFlag hasMany PortGuarPos via participationFlag
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof DomsParticipationFlag {
    return DomsParticipationFlag.init({
    domain: {
    ...
    sequelize,
    tableName: 'doms_participation_flag',
    schema: 'bzdf',
    timestamps: false,
    indexes: [
      {
        name: "doms_participation_flag_domain",
        unique: true,
        fields: [
          { name: "domain" },
        ]
      ...
      {
        name: "pk_doms_participation_flag",
        unique: true,
        fields: [
          { name: "domain" },
        ]
