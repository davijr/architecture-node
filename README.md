...
# Projeto padrão Node.js

Esse é um projeto padrão Node.js utilizando padrões de projeto.


Conteúdo está diponível no GitHub
...
- Stack 🌟
    ...
    - [ ] (DEV) Sucrase - Typescript live reload
    - [ ] (DEV) Pino - Logger
    - [ ] (DEV) ESLINT - Padronização de linha de código
    - [ ] (DEV) Instalar extensão ESLINT no VS Code
    - [ ] Sequelize ORM
    - [ ] Docker compose com imagem do PostgreSQL
